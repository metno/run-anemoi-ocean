...
def get_parser():
    ...
    parser.add_argument('-t', '--total_time', type=str, default=None, help='Expected total execution time, splitted across several jobs if needed. Format: D-HH-MM-SS or HH-MM-SS')
