...
pip install --user -e anemoi-core/training
pip install --user -e anemoi-core/models
pip install --user -e anemoi-core/graphs
...
pip install --user -e anemoi-utils
...
pip install --user -e anemoi-datasets
...
pip install --user -e anemoi-transform
